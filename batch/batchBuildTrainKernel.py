###########################################
#           batchBuildTrainKernel         #
###########################################
# build kernels for training
# steps:
#   1. input 
...
def help():
    print "usage: python batchBuildTrainKernel.py [root] [feature] [begin:end]"
    print 
    print "  e.g: python batchBuildTrainKernel.py ../exp/train rgba_gist+rgba_phog 0  10 "
    print "       python batchBuildTrainKernel.py ../exp/train rgba_gist+rgba_phog 10 20 "
    print "       python batchBuildTrainKernel.py ../exp/train rgba_gist+rgba_phog 20 30 "
    print "       python batchBuildTrainKernel.py ../exp/train rgba_gist+rgba_phog 30 40 "
    print 
    print "file required:"
