function [] = mklv2_test_result_to_csv(features, emotion_file_path, input_data_folder, exp_tag, sample_tag, output_file_name, file_prefix)
...
for i=1:length(features)
    ...
    for j=2:length(emotions)+1
        file_name = sprintf('%s%d_%s_%s_%s_%s_test_result.mat', file_prefix, j-1, exp_tag, sample_tag, emotions{j-1}, features{i});
