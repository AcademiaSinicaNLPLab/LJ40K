function [] = mklv2_exp_2(emotion_idx, output_prefix, features, train_data_root, test_data_root, train_data_tag, test_data_tag, nclass_neg, n_fold)
...
disp(sprintf('\n===============RE-BUILD KERNEL===================='));
[K_train, weight, info_kernel, Xnorm_train, Xnorm_test] = mklv2_build_kernel(kernel_param, dim, X_train, X_test_fused, options, feature_start_idx);
