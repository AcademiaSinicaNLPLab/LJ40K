...
output_file_path = 'output/exp_2_eval_result_15020215.csv';
...
mklv2_test_result_to_csv(features, emotion_file_path, input_data_folder, exp_tag, sample_tag, output_file_path);
